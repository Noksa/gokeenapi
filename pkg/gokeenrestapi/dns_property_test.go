...
func TestProperty_DNSAddCommandsValidAndParseable(t *testing.T) {
...
func TestProperty_DomainNameValidation(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
...
func TestProperty_DNSDeleteCommandCorrectness(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
